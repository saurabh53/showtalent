...
class Trie:
	...
	def has_word(self,word):
		if word=='':
			return False
		if word==None:
			raise ValueError('Trie requires not null string')
	...
	def start_with_prefix(self,prefix):
		# return list of all words in tree that starts with prefix
		words = list()
		if prefix == None:
			raise ValueError('Requires not null string')
		top_node = self.head
...
# 	print trie.start_with_prefix('too')	
